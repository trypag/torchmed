...
class ModSegNet(nn.Module):
    """Inspired from SegNet https://arxiv.org/abs/1511.00561
    ...
    """
    def __init__(self, num_classes, n_init_features=7, drop_rate=0.5,
    ...
    def forward(self, x):
        ...
        return F.log_softmax(self.classifier(feat_decoder), dim=1)
